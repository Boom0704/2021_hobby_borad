                ...
                <table class="inquiriesTable">
                    <thead>
                        <tr>
                            ...
                            <th width="1300px" colspan="2">제목</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td width="500px"><p class="num">제안 취미 종류</p></td>
                            <td width="500px"><p class="title">제안 취미 영역</p></td>
                            <th width="400px">작성자</th>
                        </tr>
                        <tr>
                            <td colspan="3" width="1400px" height="500px"><p class="num">글 내용</p></td>
                        </tr>
                        <tr>
                            <td colspan="3" width="1400px" >

...
<html>
    <head>
        <meta charset="urf-8" />
        <title>취미 메인</title>
        <link rel="stylesheet" href="fpOpenClass_css.css">
        ...
        <script>
            ...
            function newInquiries(){
                window.open("inquiriesNewHobby.html", "회원가입", "top=100px, left=100px, height=750px, width=1000px");
            }
        </script>
    </head>
    ...
    <body>
        ...
        <div class="bodypart">
            ...
            <section class="inquiries">
                <h2 class="inquiriesTitle">클래스 개설 문의</h2>
                <table class="inquiriesTable">
                    ...
                    <tbody>
                        <tr onclick="location.href='fpInquiriesNewHobby.html'">

...
<html>
    <head>
        ...
        <meta charset="urf-8" />
        <title>취미 메인</title>
        <link rel="stylesheet" href="fpClass_css.css">
    ...
    <body>
        ...
        <div class="bodypart">
            ...
            <section class="classside">
                <ul class="showchannel" id="showchannel">
                    <li>
                        <a href="fpLecture.html">
                            <h2 class="h2pic"><img src="img/pic1.png" alt=""></h2>
                            <ul>
                                <li>안녕하세요</li>
                            </ul>
                        </a>
                    ...
                    <li>
                        <a href="">
                            <h2 class="h2pic"><img src="img/pic2.png" alt=""></h2>
                            <ul>
                                <li>안녕하세요</li>
                            </ul>
                        </a>
                    ...
                    <li>
                        <a href="">
                            <h2 class="h2pic"><img src="img/pic3.png" alt=""></h2>
                            <ul>
                                <li>안녕하세요</li>
                            </ul>
                        </a>
                    ...
                    <li>
                        <a href="">
                            <h2 class="h2pic"><img src="img/pic4.png" alt=""></h2>
                            <ul>
                                <li>안녕하세요</li>
                            </ul>
                        </a>

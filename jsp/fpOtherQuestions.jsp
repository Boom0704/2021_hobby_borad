...
<html>
    <head>
        <meta charset="urf-8" />
        <title>취미 메인</title>
        <link rel="stylesheet" href="fpOtherQuestions_css.css">
        ...
        <script>
            ...
            function newInquiries(){
                window.open("inquiriesOther.html", "회원가입", "top=100px, left=100px, height=750px, width=1000px");
            }
        </script>
    </head>
    ...
    <body>
        ...
        <div class="bodypart">
            ...
            <section class="inquiries">
                <h2 class="inquiriesTitle">기타 다른 문의 사항</h2>
                <table class="inquiriesTable">
                    <thead>
                        <tr>
                            <th width="100px">글 번호</th>
                            <th width="1300px">제목
                                <input type="button" class="newInquiries" value="새로운 질문 추가" onclick="newInquiries()">
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr onclick="location.href='fpInquiriesOther.html'">
                            <td ><p class="num">1</p></td>
                            <td ><p class="title">문의 1</p></td>
                        </tr>
                        <tr onclick="location.href='fpInquiriesOther.html'">
                            <td ><p class="num">2</p></td>
                            <td ><p class="title">문의 2</p></td>
                        </tr>
                    </tbody>
                </table>
            </section>
